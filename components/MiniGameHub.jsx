  ...
  return (
    <div className="game-hub">
      <div className="game-stage" ref={stageRef} role="tabpanel" aria-label={`${current.playable ? 'Jogar' : 'Ver prévia de'} ${current.title}`}>
        ...
        {selected === 'canto' && <EmbeddedWebGame src="/games/canto-azul/index.html?v=2" title="Canto Azul, aventura pixel art brasileira sobre natureza e preservação" mobileControls />}
